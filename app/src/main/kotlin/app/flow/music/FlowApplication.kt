...
import app.flow.music.data.mediastore.ArtworkFetcher
import app.flow.music.data.mediastore.ArtworkRequest
...
class FlowApplication : Application(), SingletonImageLoader.Factory {
    ...
    override fun newImageLoader(context: PlatformContext): ImageLoader =
        ImageLoader.Builder(context)
            .components { add(ArtworkFetcher.Factory(this@FlowApplication)) }
            .memoryCache {
                MemoryCache.Builder()
